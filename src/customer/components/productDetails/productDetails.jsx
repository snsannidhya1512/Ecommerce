...
export default function ProductDetails() {
  ...
  const handleAddToCart = () => {
    if (!selectedSize) {
      alert("Please select a size"); // Example validation
      return;
    }

    const reqData = {
      jwt: jwt, // Assuming jwt is obtained from somewhere (Redux state, local storage, etc.)
      data: {
        productId: productId,
    ...
    // Dispatch addItemToCart action with reqData
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:text-xl font-sem-bold text-gray-900">
                {" "}
              ...
              <Grid xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    readOnly
                  />
                  <p className="opacity-60">59455 Ratings</p>
                </div>
