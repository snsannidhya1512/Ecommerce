...
const CartItem = ({ item }) => {
  ...
  const handleUpdateCartItem = (num) => {
    const data = {
      ...
      cartItemId: item?._id, // Use _id instead of id
    };
  ...
  const handleRemoveCartItem = () => {
    console.log("Removing cart item:", item._id);
    dispatch(removeCartItem(item._id)); // Use _id instead of id
  };
    ...
    <div className="p-5 shadow-lg border rounded-md">
      <div className="flex items-center">
        <div className="w-[5rem] h-[5rem] lg:w-[9rem] lg:h-[9rem]">
          <img
            className="w-full h-full object-cover objet-top"
